...
//        	defensa.setText(defensa.getText() + arm.getNombre()+" : + "+ arm.getDefensa()+ "\n");        	
        	for (AtaqueVO atac: arm.getAtaques()) {
        		...
        		ataques.setText(Html.fromHtml( ataques.getText()+ "<b>"+ atac.getNombreataque()+":</b> Daño "  + atac.getFactor() + ", acierto "+ atac.getAcierto() + "%, Atributo " + atac.getAtributoafectado() + ", Veces de uso: " + atac.getVecesuso() + ", Afecta a " + afectado + "\n"));

...
import ea.grupo2.Bumaye.android.CustomAdapter.Holder;

public class CustomAdapterBatalla extends BaseAdapter{   
	String [] result;
	int [] cantidad;
	Context context;
	private static LayoutInflater inflater=null;
	public CustomAdapterBatalla(BatallaActivity inventarioActivity, String[] prgmNameList, int[] prgmCantidadList) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		View rowView;       
		rowView = inflater.inflate(R.layout.objeto_batalla_adapter, null);
